...
export default _make('Pubsub', [
    ...
    _createBulkSubscribeMethod (subscribeMethodName) {
    ...
    _init (...args) {
        ...
        this.prototype.bulkSubscribe = this._createBulkSubscribeMethod('subscribe');
        ...
        this.prototype._bulkSubscribe = this._createBulkSubscribeMethod('_subscribe');
